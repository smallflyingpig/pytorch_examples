...
from models import resnet, resnet_resample
...
def parser():
    ...
    parser.add_argument('--pool_type', type=str, choices=['none', 'sample'], help='none, sample')
...
def prepare_log(args):
    ...
    writer = SummaryWriter(logdir=args.log_dir_full)
...
def main(args):
    ...
    model_dict_all = {
        ...
        'sample':{
            'resnet18':{'model':resnet_resample.ResNetSimple18, 'param': args.block_type}, 
            'resnet110':{'model':resnet_resample.ResNetSimple110, 'param':args.block_type},
            },
    }
