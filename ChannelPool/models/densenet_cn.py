...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        out = self.conv1(self.bn1(F.relu(self.channel_norm(x))))
        out = self.conv2(self.bn2(F.relu(self.channel_norm(out))))
...
class DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, num_classes=10):
        ...
        self.dense1 = self._make_dense_layers(block, num_planes, nblocks[0]) #(64+12*6)
